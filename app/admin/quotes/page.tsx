  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        ...
        return (
          <div>
              <div className="mb-6 md:mb-8">
                <h1 className="text-2xl md:text-3xl font-bold text-[#051A53] mb-2">{t('quotesContacts')}</h1>
        ...
        <div className="bg-white rounded-lg shadow-md border-t-4 border-[#051A53] overflow-hidden">
          {quotes.length === 0 ? (
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
                      <div className="flex-1 w-full">
                        <div className="flex flex-wrap items-center gap-2 md:gap-4 mb-2">
                          ...
                          <span className="px-2 md:px-3 py-1 rounded-full text-xs font-medium bg-[#051A53] text-white">
                              ...
                              {(quote as any).documents.map((doc: string | { url: string; filename?: string; id?: string }, idx: number) => {
                                ...
                                return (
                                  <a
                                    ...
                                    className="inline-flex items-center gap-1 px-3 py-1.5 text-sm bg-[#051A53] text-white rounded-lg hover:bg-[#051A53] transition-colors border border-[#051A53]"
                                  >
                      ...
                      {quote.status === 'new' && (
                        <>
                          <button
                            ...
                            className="px-3 md:px-4 py-2 text-sm md:text-base bg-[#051A53] text-white rounded-lg hover:bg-[#051A53] transition-colors"
                          >
                            {t('markAsRead')}
                          </button>
                          <button
