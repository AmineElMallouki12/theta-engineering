...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-800 to-primary-900 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl border-t-4 border-primary-900 p-6 md:p-8">
        <Link
          href="/nl"
          className="inline-flex items-center text-primary-900 hover:text-primary-800 mb-6 transition-colors font-medium"
        >
          <svg
        ...
        <div className="text-center mb-8">
          ...
          <div className="w-16 h-1 bg-primary-900 mx-auto"></div>
        </div>
