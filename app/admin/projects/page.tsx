  ...
  return (
    <div>
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-[#051A53] mb-2">{t('projects')}</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 md:mb-8">
          <button
            ...
            className="w-full sm:w-auto px-4 md:px-6 py-2 text-sm md:text-base bg-[#051A53] text-white rounded-lg hover:bg-[#051A53] transition-colors"
          >
            {t('addNewProject')}
          </button>
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button
                      ...
                      className="flex-1 px-3 md:px-4 py-2 text-sm md:text-base bg-[#051A53] text-white rounded-lg hover:bg-[#051A53] transition-colors"
                    >
                      {t('edit')}
                    </button>
                    <button
